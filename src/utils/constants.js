...
export const DEFAULT_CHURCH_PROFILE = { sinode: "GEREJA MASEHI INJILI DI TIMOR (GMIT)", klasis: "", jemaat: "NAMA GEREJA", alamat: "Alamat Gereja", namaSekretaris: "Nama Sekretaris" };
